...
namespace ZunTzu.Modelization.Commands {
	...
	/// <summary>DragDropHandPieceIntoOtherStackCommand command.</summary>
	public sealed class DragDropHandPieceIntoOtherStackCommand : Command {

		public DragDropHandPieceIntoOtherStackCommand(IModel model, Guid playerGuid, IPiece piece, IStack stackAfter, int insertionIndex)
			: base(model)
		{
			Debug.Assert(piece.Stack.Board == null && !stackAfter.AttachedToCounterSection && insertionIndex <= stackAfter.Pieces.Length);
