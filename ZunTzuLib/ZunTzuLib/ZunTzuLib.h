...
extern "C" {
	...
	__declspec(dllexport) void __cdecl RenderDieMesh(void* mesh_vb, void* mesh_ib, void* mesh_texture, int mesh_vertex_count, int mesh_triangle_count, float x, float y, float size_factor, float rot_00, float rot_01, float rot_02, float rot_10, float rot_11, float rot_12, float rot_20, float rot_21, float rot_22, unsigned int die_color, unsigned int pips_color);
	__declspec(dllexport) void __cdecl RenderCustomDieMesh(void* mesh_vb, void* mesh_ib, void* mesh_texture, int mesh_vertex_count, int mesh_triangle_count, float x, float y, float size_factor, float rot_00, float rot_01, float rot_02, float rot_10, float rot_11, float rot_12, float rot_20, float rot_21, float rot_22);
	__declspec(dllexport) void __cdecl RenderDieMeshShadow(void* mesh_vb, void* mesh_ib, void* mesh_texture, int mesh_vertex_count, int mesh_triangle_count, float mesh_inradius, float x, float y, float size_factor, float rot_00, float rot_01, float rot_02, float rot_10, float rot_11, float rot_12, float rot_20, float rot_21, float rot_22, unsigned int shadow_color);
