...
namespace ZunTzu.Modelization.Commands {
	...
	/// <summary>DragDropAttachedStackOnTopOfOtherStackCommand command.</summary>
	public sealed class DragDropAttachedStackOnTopOfOtherStackCommand : Command {

		public DragDropAttachedStackOnTopOfOtherStackCommand(IModel model, IStack stack, IStack stackAfter)
		: base(model)
		{
